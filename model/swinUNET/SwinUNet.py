...
class SwinTransformerSys(nn.Module):
    ...
    def __init__(self, img_size=128, patch_size=4, in_chans=1, out_chans=1,
        ...
        self.conv_first =  nn.Sequential(
                                   ...
                                   nn.Conv2d(in_channels=in_chans, out_channels=embed_dim, kernel_size= (3, 3), stride=1, padding=0),
        ...
        if self.final_upsample == "Dual up-sample":
            ...
            self.output = nn.Sequential(
                                   nn.ReplicationPad2d(1),
                                   nn.Conv2d(in_channels=embed_dim, out_channels=self.out_chans, kernel_size= (3, 3), stride=1, padding=0))
